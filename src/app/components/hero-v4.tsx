...
const APP_STORE_URL = "https://apps.apple.com/fr/app/imeer/id6756876683" // TODO
const PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=com.imeerptyltd.imeer" // TODO
          ...
          <div className="mb-6 flex justify-center">
            <div className="inline-flex items-center gap-3 rounded-full border border-white/15 bg-white/10 px-4 py-2 backdrop-blur-sm shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
              ...
              <span className="text-sm sm:text-base font-semibold text-white/95">
                🚀 Available on iOS & Android · Australia&apos;s First Family Reward Platform
              </span>
            </div>
          </div>
          {/* Eyebrow */}
              ...
              <div className="space-y-6 order-2 lg:order-1">
                <div className="hero-card rounded-2xl p-6 text-center">
                  ...
                  <div
                    ...
                    className={`stats-counter ${statsVisible ? "opacity-100" : "opacity-0"
                      } cursor-pointer hover:scale-105 transition-all duration-300`}
                  >
                    <p className="hero-title text-3xl font-bold">NOW LIVE</p>
                    <p className="hero-description text-sm">
                      Join families already using iMEER<br />
                      Kids completing tasks, rewards being earned, families building routines<br />
                      <span className="font-semibold">Join In</span>
                    </p>
                  </div>
                </div>
                <div className="hero-card rounded-2xl p-6 text-center">
                  ...
                  <div className={`stats-counter ${statsVisible ? "opacity-100" : "opacity-0"}`}>
                    ...
                    <p className="hero-description text-sm">Available on iOS & Android</p>
                  </div>
                </div>
              </div>
